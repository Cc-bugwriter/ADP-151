...
static const char *CompileLibs[] = {
    /* /net/pluto/local/work.pt/cm/src_lib/Portings/linux64/lib/libcar.a */
    /* /net/pluto/local/work.pt/cm/src_lib/Portings/linux64/lib/libcarmaker.a */
    /* /net/pluto/local/work.pt/cm/lib/driver/linux64/lib/libipgdriver.a */
    /* /net/pluto/local/work.pt/cm/lib/road/linux64/lib/libipgroad.a */
    /* /net/pluto/local/work.pt/cm/lib/tire/linux64/lib/libipgtire.a */
    "libcar.a	CarMaker-Car linux64 8.1 2019-11-08",
    "libcarmaker.a	CarMaker linux64 8.1 2019-11-08",
    "libipgdriver.a	IPGDriver linux64 8.1 2019-10-31",
    "libipgroad.a	IPGRoad linux64 8.1 2019-11-05",
...
static const char *CompileFlags[] = {
    ...
    "-D_FILE_OFFSET_BITS=64 -DCM_NUMVER=80100 -DMYMODELS",
    "-m64 -fPIC -Wall -Wimplicit -Wmissing-prototypes",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 8.1 - Car_Generic",          /* App_Version         */
    "52",          /* App_BuildVersion    */
    "pt",     /* App_CompileUser     */
    "pluto.ipg",         /* App_CompileSystem   */
    "2019-11-08 10:56:52",  /* App_CompileTime */
